...
public class BeamBullet extends Bullet 
{
	...
	public BeamBullet(double xspawn, double yspawn)
	{
		heading = 0;
		width = 4;
		height = 32;
	...
	{//the bullet sets the remove flag if it hits something.
		...
		{
			this.removeme = true;//the gun bullet will be removed, regardless of the other conditions.
