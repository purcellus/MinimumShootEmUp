...
{	//similar to a GunBullet, except it will not destroy itself if it hits a target.
	...
	public PierceBullet(double xspawn, double yspawn)
	{
		heading = 0;
		width = 4;
		height = 4;
	...
	{//checks to see if the object needs to be removed.
		...
		if (life <= 0)
		{
			//System.out.println("Remove flag for PierceBullet is true");
			this.removeme = true;
		} else
		{
			//System.out.println("Check autoremove in PierceBullet " + removeme);
