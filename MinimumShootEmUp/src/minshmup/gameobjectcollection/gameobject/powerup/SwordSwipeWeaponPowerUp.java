...
public class SwordSwipeWeaponPowerUp extends PowerUp
{//increases the weaponstrength by one.
	...
	public SwordSwipeWeaponPowerUp(int translatex, int translatey)
	{
	...
	public void draw(Graphics g)
	{
		...
		g2d.setColor(Color.BLACK);//to differentiate it from swordstab
