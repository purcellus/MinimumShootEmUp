...
public class GunWeapon extends WeaponTypeStrategy
{
	...
	private FireGunBullet firegunbulletcmd = FireGunBullet.getFireWeapon(null);
	...
	public GunWeapon(int translatex, int translatey)
	{
		gunstrength = 1;
	...
	{
		// TODO Auto-generated method stub
		firegunbulletcmd.actionPerformed(null);
