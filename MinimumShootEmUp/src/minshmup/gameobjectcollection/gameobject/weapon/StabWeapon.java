...
public class StabWeapon extends WeaponTypeStrategy
{
	...
	private FireStab firestabcmd = FireStab.getFireStabWeapon(null);
	...
	public StabWeapon(int translatex, int translatey)
	{
		gunstrength = 1;
	...
	{
		// TODO Auto-generated method stub
		firestabcmd.actionPerformed(null);
