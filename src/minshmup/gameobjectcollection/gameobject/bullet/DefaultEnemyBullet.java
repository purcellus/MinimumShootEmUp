...
public class DefaultEnemyBullet extends EnemyBullet 
{//same as the default player's bullets, but different for collision handling purposes.
	...
	public DefaultEnemyBullet(double xspawn, double yspawn)
	{
		heading = 0;
		width = 4;
		height = 4;
	...
	{//the bullet sets the remove flag if it hits something.
		...
		{//if the other object is any type of enemy ship...
