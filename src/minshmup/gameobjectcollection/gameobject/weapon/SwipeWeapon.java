...
public class SwipeWeapon extends WeaponTypeStrategy
{
	...
	private FireSwipe fireswipecmd = FireSwipe.getFireSwipeWeapon(null);
	...
	public SwipeWeapon(int translatex, int translatey)
	{
		gunstrength = 1;
	...
	{
		return new SwordSwipeBullet(0,0);
	}
	...
	public void fireWeapon() {
		// TODO Auto-generated method stub
		fireswipecmd.actionPerformed(null);
